...
export async function PATCH(
  ...
  const msg = `${icon} [Xử lý hóa đơn]
Hóa đơn: ${expense.title} (${formatVND(expense.amount)})
Trạng thái: ${statusLabel} bởi Trưởng nhóm`;

  sendMultipleUsersZaloNotification([expense.createdById, expense.paidById], msg);
